...
export default function NavBar() {
    ...
    return (
        <Navbar expand='lg' className={`FM-nav-bar ${header ? 'FM-nav-bar-scroll' : 'bg-white'}`} fixed='top'>
            <Navbar.Brand className={`FM-logo ${header ? 'text-white ' : 'FM-logo-dark'}`} href="/">Logo</Navbar.Brand>
